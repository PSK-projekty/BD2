...
DROP TABLE Adres;
DROP TABLE Naprawa;
DROP TABLE JazdaProbna;
DROP TABLE Platnosc;
DROP TABLE Sprzedaz;
DROP TABLE Akcesoria;
DROP TABLE Stanowiska;
DROP TABLE WersjaWyposazenia;
DROP TABLE Wynajem;
DROP TABLE Czesci;
DROP TABLE DodatkoweWyposazenie;
DROP TABLE Magazyn;
DROP TABLE Wynajem_Pracownicy;
DROP TABLE Wynajem_Klient;
DROP TABLE Czesci_Samochod;
DROP TABLE Wynajem_Samochod;
DROP TABLE Akcesoria_Samochod;
DROP TABLE Dodatkowe_Samochod;
DROP TABLE WyposazenieSprzedaz;
