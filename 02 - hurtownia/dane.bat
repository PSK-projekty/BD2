...
sqlldr %user%/%pass%@%instance% CONTROL=Loader\Wymiar_Stanowisko\Wymiar_Stanowisko.ctl
...
sqlldr %user%/%pass%@%instance% CONTROL=Loader\Wymiar_Pracownik\Wymiar_Pracownik.ctl
